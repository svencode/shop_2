package com.cqgk.shennong.shop.view.scan;
 ...
 */
public class TagetImageView extends ImageView {
    private Context context;

    public TagetImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public TagetImageView(Context context) {
        super(context);
        this.context = context;
    }
